...
| `fixtures/labels/sources/264-1241-stryax-epa-label-20260206.pdf` + `264-1241.json` | [EPA Stryax label](https://www3.epa.gov/pesticides/chem_search/ppls/000264-01241-20260206.pdf); wired as pack `dupage_stryax_pula` | **2026-08-23** / **2026-09-17** |
| `fixtures/mitigation_menu.json` + `fields/field_boone.json` | [Iowa State ICM Table 1](https://crops.extension.iastate.edu/post/prepare-now-2026-epa-endangered-species-requirements) (Anderson, 11 Mar 2026) citing [EPA Mitigation Menu](https://www.epa.gov/endangered-species/mitigation-menu); field pin at ISU Ag Engineering/Agronomy Research Farm, Boone (`42.019052, -93.774039`) | **2026-09-13** (coords) / **2026-08-23** (menu) |
| `fixtures/fields/field_dupage_west_chicago.json` | Contrast field at `41.8891, -88.2233` (West Chicago Prairie vicinity); modest practices so PULA +3 yields POINTS_SHORT | **2026-09-17** |
...
| `fixtures/bulletins/blt-dupage-il-264-1241-2026-09.pdf` + `.json` | Real BLT Printable Bulletin — DuPage / West Chicago Prairie + **September 2026** + **264-1241**; **DC125** = +3 runoff points (total 6) | Printed **2026-09-17** |
